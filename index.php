...
<div id="container">
    ...
    <div id="header">
        ...
        <img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1497771136979&di=e2ba18116dfe8cd21268bd1858507f36&imgtype=0&src=http%3A%2F%2Fwww.qqzhi.com%2Fuploadpic%2F2014-05-06%2F050322466.jpg">
    </div>
        ...
        <div id="text">
            ...
            <div id="modal" style="display:none;">
                ...
                <div class="modal-addition modal-by-text">
                    <span class="content-font diary-by-text">归档于:&nbsp;
                        <a class="under-line"></a></span>&emsp;
                    <span class="content-font diary-by-text">撰写于:&nbsp;
                    ...
                    <i class="wi"></i>&emsp;
                    <img class="modal-emotion" src="" alt="心情">
                </div>
                <div class="content-font content-color content-line modal-content"></div>
                <!-- <div class="division-line"></div> -->
                <div class="comments content-font">
                    <p><strong>评论</strong> <small>( 12 )</small></p>
                    <p class="comment">
                        <span>Jie :</span>
                        <span class="comment-content">这是我自己写的一篇日记，你觉得如何呢？</span>
                    </p>
                </div>
            </div>
            <!-- 正文 -->
